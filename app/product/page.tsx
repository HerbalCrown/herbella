...
const packages = {
  ritual: {
    ...
    units: 1,
    price: 650,
    copy: "A first taste of Herbella",
  },
  duo: {
    id: "duo",
    name: "The Duo",
  ...
  crown: {
    ...
    units: 3,
    price: 1650,
    copy: "Your complete 90-day ritual",
  },
} as const;
    ...
    return (
      <main className="checkout-page">
        <section className="success-card">
          <img src="/assets/crown-mark.svg" alt="" />
          <p className="checkout-kicker">ORDER RECEIVED</p>
          <h1>
            Thank you for choosing <em>Herbella.</em>
          </h1>
          <p>
            Your Cash on Delivery order has been recorded. Our care team will
          ...
          {!result.emailSent && (
            <p className="email-note">
              Your order is safe. The email service is awaiting final setup.
            </p>
          )}
    ...
    <main className="checkout-page">
      ...
      <section className="product-shell">
        <div className="product-showcase">
          <p className="checkout-kicker">BOTANICAL LUXURY HAIR OIL</p>
          <div className="checkout-image">
            <img
              src="/assets/herbella-bottle.png"
              alt="Herbella botanical hair oil"
            />
            <span>{item.units} × 100 ml</span>
          </div>
          <h1>{item.name}</h1>
          <p>{item.copy}</p>
          <div className="package-tabs" aria-label="Choose a package">
            {Object.values(packages).map((option) => (
              ...
              >
                <span>
                  {option.units} bottle{option.units > 1 ? "s" : ""}
                </span>
        ...
        <form className="checkout-form" onSubmit={submitOrder}>
          <div className="checkout-heading">
            ...
            <h2>
              Complete your <em>ritual.</em>
            </h2>
            <p>Delivery across Pakistan · Pay when your order arrives.</p>
          </div>
          ...
          <fieldset>
            ...
            <label className="payment-option">
              ...
              <span>
                ...
                <small>Pay in cash when your Herbella order arrives.</small>
              </span>
              <b>COD</b>
            </label>
            <p className="future-payments">
              Card and wallet payments are coming soon.
            </p>
          </fieldset>
          ...
          <p className="checkout-terms">
            By placing your order, you confirm that your delivery details are
            correct.
          </p>
        </form>
      </section>
